       ...
       /* holder.tv_preparacao.setText(alimentacao.getAlimentacao_preparacao_id()  + " - " + alimentacao.getAlimentacao_preparacao());
        ...
        if (mostrar != 2) {
            if (alimentacao.getAlimentacao_preparacao_id().toString().equals("") || alimentacao.getAlimentacao_preparacao_id().toString().equals("0")) {
                ...
                check = false;
            } else if ((alimentacao.getAlimentacao_quantidade().toString().equals("")) || alimentacao.getAlimentacao_quantidade().toString().equals("0") && (alimentacao.getAlimentacao_fracao().toString().equals("") || alimentacao.getAlimentacao_fracao().toString().equals("0") )) {
                check = false;
            }
        }else{
