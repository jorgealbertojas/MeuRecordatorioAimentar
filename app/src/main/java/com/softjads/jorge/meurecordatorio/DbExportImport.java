...
public class DbExportImport extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_db_export_import);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(DbExportImport.this,
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    bkp(Modulo.caminhobanco,Modulo.storage +NomeCopia + filtro_desc_pesquisa + DataCompleta +".db");
