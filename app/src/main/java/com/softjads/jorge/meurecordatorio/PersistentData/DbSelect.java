...
public class DbSelect {
    ...
    public static String GET_HELP =
            " SELECT "
                    + Field.FIELD_HELP_KEY  + ","
                    + Field.FIELD_HELP_VALUE + ","
                    + Field.FIELD_HELP_LAST +
                    " FROM " + DbCreate.TABLE_HELP ;
    ...
    public static String GET_ALIMENTACAO =
            " SELECT "
                    ...
                    + Field.FIELD_ALIMENTACAO_FRACAO  + ","
                    + Field.FIELD_ALIMENTACAO_QUANTIFICACAO  + ","
    ...
    public static String GET_ALIMENTACAO_DISTICT =
            " SELECT distinct "
                    + Field.FIELD_ALIMENTACAO_ID  + ","
                    + Field.FIELD_ALIMENTACAO_ALIMENTO_ID  + ","
                    + Field.FIELD_ALIMENTACAO_ALIMENTO  + ","
